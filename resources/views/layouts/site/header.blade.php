        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index.html" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="{{ asset('logo/logo.png') }}" alt="" height="26"> <span class="logo-txt">Acesso</span>
                    </span>
                </a>
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow">
                        <i class="bx bx-map-alt nav-icon"></i>
                        <span class="menu-item" data-key="t-maps">Enunciados</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('admin.enunciado.index')}}" data-key="t-google">Listar</a></li>
                        <li><a href="{{ route('admin.enunciado.create') }}" data-key="t-vector">Cadastrar</a></li>
                    </ul>
                </li>
                <li>
                    <a href="javascript: void(0);" class="has-arrow">
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow">
                        <i class="bx bx-map-alt nav-icon"></i>
                        <span class="menu-item" data-key="t-maps">Usuários</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                ...
                <li>  
                    <a href="javascript: void(0);" class="has-arrow">
                        <i class="bx bx-map-alt nav-icon"></i>
                        <span class="menu-item" data-key="t-maps">Folhas de Respostas</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('admin.folhaResposta.index')}}" data-key="t-google">Listar</a></li>
                        <li><a href="{{ route('admin.folhaResposta.create') }}" data-key="t-vector">Cadastrar</a></li>
                    </ul>
                </li>
                <li>  
                    <a href="javascript: void(0);" class="has-arrow">
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="{{ route('admin.banco_pergunta.create') }}" data-key="t-vector">Cadastrar</a></li>
                    </ul>
                </li>
                <li>  
                    <a href="javascript: void(0);" class="has-arrow">
